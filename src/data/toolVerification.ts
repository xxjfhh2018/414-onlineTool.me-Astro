...
export const toolVerification: Record<string, ToolVerification> = {
  ...
  'roth-401k-calculator': { status:'estimate', statusLabel:'2026 limits · planning estimate', versionLabel:'2026 IRS elective-deferral limits', lastReviewed:'2026-08-14', sourceLabel:'IRS Bulletin 2025-49', sourceUrl:'https://www.irs.gov/irb/2025-49_IRB', reviewNote:'Review before 2027 and whenever IRS retirement-plan limits or catch-up rules change.', exclusions:['Hypothetical constant return; excludes employer contributions, fees, taxes, withdrawals, loans, inflation, eligibility, compensation limits, and plan rules.'] },
  'schd-calculator': { status:'estimate', statusLabel:'User-assumption scenario', versionLabel:'No live market data or forecast', lastReviewed:'2026-08-14', sourceLabel:'Official SCHD fund page', sourceUrl:'https://www.schwabassetmanagement.com/products/schd', reviewNote:'Keep all return and yield assumptions user-entered; never silently add live or stale market figures.', exclusions:['Not a forecast; excludes live price, current yield, distribution history, fees, taxes, timing, and market losses.'] },
  'tire-pressure-calculator': { status:'estimate', statusLabel:'Physics estimate · not recommended pressure', versionLabel:'Constant-volume ideal-gas model', lastReviewed:'2026-08-14', sourceLabel:'NHTSA TireWise', sourceUrl:'https://www.nhtsa.gov/vehicle-safety/tires', reviewNote:'Retest absolute-pressure and unit conversions; keep placard guidance visible near every result.', exclusions:['Never replaces the vehicle cold-pressure placard; excludes leaks, driving heat, sunlight, altitude, gauge error, load, damage, and specialty use.'] },
  'partial-derivative-calculator': { status:'verified', statusLabel:'Limited polynomial engine verified', versionLabel:'Two-variable x/y polynomial parser', lastReviewed:'2026-08-14', sourceLabel:'OpenStax Calculus 3 §4.3', sourceUrl:'https://openstax.org/books/calculus-volume-3/pages/4-3-partial-derivatives', reviewNote:'Retest signs, constants, both variables, point evaluation, and every rejected syntax class after parser changes.', exclusions:['Not a general CAS; no implicit multiplication, parentheses, trig, logs, roots, quotients, or noninteger exponents.'] },
  'edpi-calculator': { status:'verified', statusLabel:'Formula verified', versionLabel:'DPI × same-game sensitivity', lastReviewed:'2026-08-14', sourceLabel:'BenQ ZOWIE eDPI guide', sourceUrl:'https://zowie.benq.com/en-au/knowledge/mouse/edpi-calculation-method-for-fps-games.html', reviewNote:'Retest base and target-DPI conversions and keep cross-game limitations visible.', exclusions:['Does not normalize different games, yaw constants, FOV, ADS, acceleration, OS scaling, raw input, or cm/360.'] },
  'sig-fig-calculator': { status:'verified', statusLabel:'Rounding rules verified', versionLabel:'NIST half-even rounding', lastReviewed:'2026-08-15', sourceLabel:'NIST Guide to the SI', sourceUrl:'https://www.nist.gov/pml/special-publication-811/nist-guide-si-chapter-7-rules-and-style-conventions-expressing-values', reviewNote:'Retest halfway ties, scientific notation, zero, and decimal placement whenever parsing changes.', exclusions:['Does not infer measurement uncertainty or determine how many significant figures a scientific result should retain.'] },
  'binomial-distribution-calculator': { status:'verified', statusLabel:'Probability formula verified', versionLabel:'NIST binomial PMF and CDF', lastReviewed:'2026-08-15', sourceLabel:'NIST Binomial Distribution', sourceUrl:'https://itl.nist.gov/div898/handbook/eda/section3/eda366i.htm', reviewNote:'Retest p=0, p=1, cumulative tails, and large n whenever probability logic changes.', exclusions:['Valid only for independent Bernoulli trials with a fixed success probability.'] },
  'percentage-calculator': { status:'verified', statusLabel:'Formula verified', versionLabel:'Standard percentage formulas', lastReviewed:'2026-08-15', sourceLabel:'OpenStax percentage-change formula', sourceUrl:'https://openstax.org/books/principles-financial-accounting/pages/a-financial-statement-analysis', reviewNote:'Retest zero denominators, negative changes, and mode-specific labels whenever the UI changes.', exclusions:['Percentage change is undefined from a zero starting value and may be misleading when the baseline is negative.'] },
  'binomial-calculator': { status:'verified', statusLabel:'Theorem verified', versionLabel:'Finite binomial theorem', lastReviewed:'2026-08-15', sourceLabel:'NIST DLMF §1.2', sourceUrl:'https://dlmf.nist.gov/1.2', reviewNote:'Retest signs, zero coefficients, n=0, and selected k coefficients whenever expansion logic changes.', exclusions:['Supports one variable, real numeric coefficients, and nonnegative integer exponents through 20.'] },
  'statistics-calculator': { status:'verified', statusLabel:'Descriptive formulas verified', versionLabel:'Median-of-halves quartiles', lastReviewed:'2026-08-15', sourceLabel:'NIST Measures of Scale', sourceUrl:'https://itl.nist.gov/div898/handbook/eda/section3/eda356.htm', reviewNote:'Retest odd and even counts, repeated modes, one-value samples, and pasted delimiters whenever parsing changes.', exclusions:['Does not infer population characteristics, weights, confidence intervals, missing-data rules, or alternative quartile conventions.'] },
  'mcat-score-calculator': { status:'verified', statusLabel:'Official scale arithmetic verified', versionLabel:'AAMC testing year 2026 score range', lastReviewed:'2026-08-18', sourceLabel:'AAMC MCAT Exam Scoring', sourceUrl:'https://students-residents.aamc.org/register-mcat-exam/publication-chapters/mcat-exam-scoring', reviewNote:'Review annually with AAMC scoring guidance; never add a universal raw-to-scaled conversion.', exclusions:['Adds already-scaled section scores only.','Does not estimate raw-score conversion, percentile, or admission probability.'] },
  'ap-gov-calculator': { ...apShared, versionLabel:'May 2027 published exam format', lastReviewed:'2026-08-18', sourceLabel:'AP U.S. Government and Politics exam', sourceUrl:'https://apcentral.collegeboard.org/courses/ap-united-states-government-and-politics/exam' },
  'ap-physics-1-score-calculator': { ...apShared, versionLabel:'May 2027 default · May 2026 retained', lastReviewed:'2026-08-18', sourceLabel:'AP Physics 1 exam', sourceUrl:'https://apcentral.collegeboard.org/courses/ap-physics-1/exam' },
  'apes-score-calculator': { ...apShared, versionLabel:'May 2027 published exam format', lastReviewed:'2026-08-18', sourceLabel:'AP Environmental Science exam', sourceUrl:'https://apcentral.collegeboard.org/courses/ap-environmental-science/exam' },
  'hydrates-calculator': { status:'verified', statusLabel:'Formula verified', versionLabel:'18.015 g/mol water constant', lastReviewed:'2026-08-18', sourceLabel:'LibreTexts Percent of Water in a Hydrate', sourceUrl:'https://chem.libretexts.org/Bookshelves/Introductory_Chemistry/Book%3A_Introductory_Chemistry_%28CK-12%29/10%3A_The_Mole/10.10%3A_Percent_of_Water_in_a_Hydrate', reviewNote:'Retest formula, optional sample mass, and integer hydration number whenever inputs change.', exclusions:['Does not parse chemical formulas or calculate experimental error.'] },
};
